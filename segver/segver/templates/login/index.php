          ...
          <div class="row g-0">
            ...
            <div class="col-lg-6 d-flex align-items-center">
              <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                ...
                <p class="small mb-0">Texto de prueba para el login de la aplicacion de seguimiento y verificacion. Texto de prueba para el login de la aplicacion de seguimiento y verificacion.</p>
              </div>
